...
// 建立 Icon 對應表，方便從 JSON 的字串讀取圖示
const IconMap = {
  Flame, Star, Utensils, Coffee, Trees, Pizza, Beer, Wine
};

// 完整模擬餐廳資料庫 (包含 Drive-friendly 與 High Street)
// 註：這份資料已完全格式化為 JSON 相容結構。日後在真實專案中可直接刪除此陣列，改用 fetch('restaurants.json')
const restaurants = [
  // ================= 🚗 DRIVE-FRIENDLY (方便泊車) =================
  {
    id: 1, name: "Hickory's Smokehouse", locationType: "Drive-friendly", category: "美式風味", type: "德州煙燻 BBQ",
    description: "主打正宗美國德州慢火煙燻烤肉。多數分店由大型鄉村酒館改建，擁有超大免費停車場及戶外兒童遊樂區。",
    parkingRating: 5, foodRating: 4.8, tags: ["免費泊車", "兒童友善", "郊區首選"],
  ...
  {
    id: 2, name: "Miller & Carter", locationType: "Drive-friendly", category: "高級餐飲", type: "高級牛排館",
    description: "以優質熟成牛排聞名。多數由舊式大型 Pub 改建，位於市郊並附設廣闊的專屬停車場，適合約會或慶祝。",
    parkingRating: 4, foodRating: 4.7, tags: ["專屬車位", "高級餐飲", "氣氛佳"],
  ...
  {
    id: 3, name: "Toby Carvery", locationType: "Drive-friendly", category: "傳統烤肉", type: "自助英式烤肉",
    description: "號稱「烤肉之家」，提供全日英式烤肉自助餐。絕大多數分店附設大型免費停車場，週日聚餐經典。",
    parkingRating: 5, foodRating: 4.0, tags: ["自助烤肉", "約克郡布丁", "家庭經典"],
  ...
  {
    id: 4, name: "Harvester", locationType: "Drive-friendly", category: "家庭餐廳", type: "烤雞與沙律吧",
    description: "以無限量供應的健康沙律吧和烤雞聞名。極受帶小孩的家庭歡迎，分店遍佈全英且幾乎都有專屬停車場。",
    parkingRating: 5, foodRating: 3.9, tags: ["免費沙律吧", "兒童菜單", "健康選擇"],
  ...
  {
    id: 5, name: "Vintage Inns", locationType: "Drive-friendly", category: "英式酒館", type: "高級鄉村酒館",
    description: "風景優美的傳統鄉村酒館，通常配有茅草屋頂或火爐。位於市郊或鄉間小路，設有大型停車場，適合週末自駕遊。",
    parkingRating: 4, foodRating: 4.3, tags: ["鄉村風景", "寵物友善", "烤肉"],
  ...
  {
    id: 6, name: "OK Diner", locationType: "Drive-friendly", category: "美式風味", type: "復古公路餐館",
    description: "1950年代美國公路餐館風格。位於英國主要 A-road 幹道旁，門口就是停車場，長途駕駛的最佳中途站。",
    parkingRating: 5, foodRating: 4.2, tags: ["公路直達", "全天候早餐", "無限添飲"],
    image: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", icon: "Coffee"
  },
  {
    id: 7, name: "Pizza Hut (Retail Parks)", locationType: "Drive-friendly", category: "家庭餐廳", type: "薄餅自助餐",
    description: "位於購物園區的實體餐廳分店。擁有經典的 Pizza 自助餐與雪糕機，門口通常就是超大免費停車場。",
    parkingRating: 5, foodRating: 3.8, tags: ["Pizza", "無限雪糕", "購物園區"],
  ...
  {
    id: 14, name: "Beefeater", locationType: "Drive-friendly", category: "英式酒館", type: "牛排酒館",
    description: "經常與 Premier Inn 酒店相連，提供經典的英式牛排與酒吧美食。地點多位於公路交匯處或市郊，擁有極其寬敞的停車場。",
    parkingRating: 5, foodRating: 3.8, tags: ["公路交界", "Premier Inn", "牛排"],
  ...
  {
    id: 15, name: "Hungry Horse", locationType: "Drive-friendly", category: "英式酒館", type: "平價運動酒館",
    description: "以極具性價比的大份量美食聞名。多位於市郊社區或幹道旁，擁有寬敞的專屬停車場，氣氛輕鬆熱鬧。",
    parkingRating: 4, foodRating: 3.5, tags: ["大份量", "性價比高", "體育直播"],
  ...
  {
    id: 16, name: "Farmhouse Inns", locationType: "Drive-friendly", category: "傳統烤肉", type: "烤肉與巨型蛋糕",
    description: "主打傳統英式烤肉及超巨型手工蛋糕 (Cakeaway)。通常設有大型兒童室內遊樂區，週末公路旅行完美中途站。",
    parkingRating: 5, foodRating: 4.1, tags: ["Carvery", "巨型蛋糕", "室內遊樂區"],
    image: "https://images.unsplash.com/photo-1544025162-d76694265947?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", icon: "Trees"
  },
  {
    id: 17, name: "Frankie & Benny's", locationType: "Drive-friendly", category: "家庭餐廳", type: "美意融合餐廳",
    description: "常見於各大 Retail Park 及電影院旁，提供薄餅、意粉及漢堡，吃喝玩樂停車一次搞定。",
    parkingRating: 5, foodRating: 3.7, tags: ["Retail Park", "美意融合", "看電影必吃"],
  ...
  // ================= 🛍️ HIGH STREET (繁華大街) =================
  {
    id: 8, name: "Wagamama", locationType: "High Street", category: "亞洲風味", type: "日式拉麵/咖哩",
    description: "英國最受歡迎的日式連鎖餐廳。主打日式拉麵、鐵板燒及咖哩豬排飯。長桌共餐文化，大多位於市中心黃金地段。",
    parkingRating: 1, foodRating: 4.5, tags: ["日式料理", "Katsu Curry", "市中心"],
  ...
  {
    id: 9, name: "Pizza Express", locationType: "High Street", category: "意式風味", type: "傳統薄餅",
    description: "英國高級街頭薄餅的代名詞。裝修優雅，提供正宗意大利羅馬薄餅 (Romana) 及著名的麵包球 (Dough Balls)。",
    parkingRating: 1, foodRating: 4.3, tags: ["高級薄餅", "Dough Balls", "約會佳選"],
  ...
  {
    id: 10, name: "Nando's (High Street)", locationType: "High Street", category: "多國風味", type: "葡式烤雞",
    description: "英國年輕人最愛的 PERi-PERi 烤雞店。High Street 分店通常人氣極旺，需步行前往或停在附近的收費停車場。",
    parkingRating: 2, foodRating: 4.4, tags: ["PERi-PERi", "年輕人最愛", "行街必食"],
  ...
  {
    id: 11, name: "Franco Manca", locationType: "High Street", category: "意式風味", type: "拿坡里酸種薄餅",
    description: "主打發酵 24 小時的正宗拿坡里酸種薄餅 (Sourdough Pizza)。價格親民，多位於熱鬧的高街或火車站附近。",
    parkingRating: 1, foodRating: 4.6, tags: ["酸種薄餅", "平價高質", "正宗拿坡里"],
  ...
  {
    id: 12, name: "Dishoom", locationType: "High Street", category: "亞洲風味", type: "孟買風印度菜",
    description: "向舊孟買的伊朗咖啡館致敬的高級印度餐廳。裝修極具復古情調，黑達爾扁豆 (Black Daal) 是必點招牌，經常大排長龍。",
    parkingRating: 1, foodRating: 4.8, tags: ["高級印度菜", "Black Daal", "復古裝潢"],
  ...
  {
    id: 13, name: "Zizzi", locationType: "High Street", category: "意式風味", type: "意式休閒餐廳",
    description: "提供豐富的意大利麵、薄餅及甜品。內部裝潢通常充滿藝術感，設有開放式廚房，是逛街後家庭聚餐的熱門選擇。",
    parkingRating: 2, foodRating: 4.1, tags: ["意粉", "休閒聚餐", "大街熱門"],
  ...
  {
    id: 18, name: "Turtle Bay", locationType: "High Street", category: "多國風味", type: "加勒比海菜",
    description: "以充滿活力的加勒比海氣氛、烤雞 (Jerk Chicken) 和 2-for-1 雞尾酒聞名。非常適合週末狂歡，通常位於市中心。",
    parkingRating: 1, foodRating: 4.4, tags: ["雞尾酒", "加勒比海", "派對氣氛"],
  ...
  {
    id: 19, name: "Côte Brasserie", locationType: "High Street", category: "法式風味", type: "法式小酒館",
    description: "提供經典優雅的法國菜，如法式烤雞和紅酒燉牛肉。環境精緻，是高街上享用早午餐或浪漫晚餐的熱門選擇。",
    parkingRating: 1, foodRating: 4.6, tags: ["法國菜", "早午餐", "優雅環境"],
    image: "https://images.unsplash.com/photo-1550966871-3ed3cdb5ed0c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", icon: "Wine"
  },
  {
    id: 20, name: "Bill's", locationType: "High Street", category: "英式現代", type: "全日英式餐廳",
    description: "裝潢色彩繽紛且充滿古董擺設。提供從豐盛早餐到豐富晚餐的現代英式料理，是逛街累了極佳的休息站。",
    parkingRating: 1, foodRating: 4.3, tags: ["全日供餐", "打卡餐廳", "現代英式"],
  ...
  {
    id: 21, name: "Honest Burgers", locationType: "High Street", category: "美式風味", type: "手工漢堡",
    description: "以高品質的英國牛肉漢堡和自家製的迷迭香薯條 (Rosemary Chips) 征服食客。店面通常不大但總是客滿。",
    parkingRating: 1, foodRating: 4.5, tags: ["手工漢堡", "迷迭香薯條", "高品質肉類"],
...
export default function App() {
  ...
  // 頂層 Filter 狀態 (Drive-friendly 或 High Street)
    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-800 pb-12">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex space-x-4 sm:space-x-8">
              <a href="#" className="text-blue-600 font-medium border-b-2 border-blue-600 px-1 py-2 text-sm sm:text-base">找連鎖餐廳</a>
              <a href="#" className="text-gray-500 hover:text-gray-900 px-1 py-2 transition-colors text-sm sm:text-base hidden md:block">我的最愛</a>
            </div>
          </div>
        </div>
      </nav>

      {/* ================= 頂層切換器 (Highest Level Filter) ================= */}
        ...
        <div className="max-w-3xl mx-auto px-4 py-4 sm:py-6">
          <div className="flex p-1 bg-gray-100 rounded-2xl shadow-inner relative">
            ...
            >
              ...
              <span>方便泊車 <span className="hidden sm:inline">(Drive-friendly)</span></span>
            </button>
            ...
            >
              ...
              <span>繁華大街 <span className="hidden sm:inline">(High Street)</span></span>
            </button>
          </div>
        </div>
      </div>

      {/* 英雄區塊 (Hero Section) - 根據選擇改變背景與文案 */}
      <div className={`text-white py-12 sm:py-16 relative overflow-hidden transition-colors duration-500 ${
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight mb-4">
            {activeLocationType === "Drive-friendly" ? (
              <>全英 <span className="text-orange-500">泊車友善</span> 餐廳大全</>
            ) : (
              <>英國 <span className="text-indigo-400">熱門大街</span> 連鎖品牌</>
            )}
          </h1>
          <p className="mt-4 text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto mb-8 px-4">
            {activeLocationType === "Drive-friendly"
              ? "為駕駛者而設。收錄郊區、Retail Park、公路旁擁有「無敵大車位」的連鎖餐廳。"
              : "行街血拼必備。收錄英國各大市中心 High Street 最受歡迎的日式、意式及多國連鎖美食。"}
          </p>
          ...
          <div className={`max-w-xl mx-auto relative bg-white rounded-full flex items-center p-2 shadow-lg focus-within:ring-2 transition-all ${
            ...
            <input
              type="text"
              placeholder={activeLocationType === "Drive-friendly" ? "搜尋烤肉, Pub, Hickory's..." : "搜尋拉麵, 薄餅, Wagamama..."}
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6 text-gray-500 text-sm font-medium flex items-center">
          ...
          顯示 {filteredRestaurants.length} 間 {activeLocationType === "Drive-friendly" ? "泊車友善" : "大街熱門"} 連鎖餐廳
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          {filteredRestaurants.length > 0 ? (
                ...
                <div className="p-5 sm:p-6 sm:w-3/5 flex flex-col h-full justify-between">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100 mt-auto">
                    <div className="flex gap-4">
                      {/* 泊車評分 (如果是大街餐廳，通常分數很低，這裡顯示紅色警示) */}
                      <div className="flex flex-col">
                        <span className="text-gray-400 text-[10px] uppercase font-bold tracking-wider">泊車</span>
                      ...
                      <div className="flex flex-col border-l border-gray-100 pl-4">
                        <span className="text-gray-400 text-[10px] uppercase font-bold tracking-wider">餐飲</span>
                        <div className="flex items-center">
            ...
            <div className="col-span-full py-16 text-center text-gray-500 flex flex-col items-center bg-white rounded-2xl border border-dashed border-gray-300">
              ...
              <p className="text-lg font-medium text-gray-900">找不到符合條件的餐廳</p>
              <button
